const contentLetterSrart_actived =
  "Chúc mừng sinh nhật em gái yêu quý, Thiên An! 🎂🌟"; //Lời mở đầu cho bức thư
const mainContentLetter =
  "Hôm nay là ngày đặc biệt của em, anh muốn gửi đến em mọi điều tốt đẹp nhất. Mong rằng tuổi mới sẽ mang đến cho em thật nhiều niềm vui, sức khỏe, và may mắn trong mọi việc. Chúc cho đứa em xinh đẹp, giỏi giang, giàu nữa chứ sẽ sớm tìm được những gì mình mong muốn. Happy New Year Thiên An ❤️";
